...
#define SX126X_CS 15    // EBYTE module's NSS pin
#define SX126X_SCK 14   // EBYTE module's SCK pin
...
// DIO2 and TXEN).
#define SX126X_TXEN 38 // Schematic connects EBYTE module's TXEN pin to MCU
#define SX126X_RXEN 37 // Schematic connects EBYTE module's RXEN pin to MCU
